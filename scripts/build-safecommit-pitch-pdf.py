...
def build() -> None:
    ...
    text(canvas, "github.com/Frankie744/safeflash-ai", 830, 370, 16, INK)
    text(canvas, "Public demo", 830, 305, 16, MUTED, BOLD)
    text(canvas, "BLOCKED", 830, 270, 18, RED, BOLD)
    text(canvas, "Braintrust Experiment", 830, 215, 16, MUTED, BOLD)
    text(canvas, "BLOCKED", 830, 180, 18, RED, BOLD)
